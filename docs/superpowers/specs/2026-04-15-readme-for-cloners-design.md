...
- **Don't touch [PROJECT_SPEC.md](../../../PROJECT_SPEC.md) or [CLAUDE.md](../../../CLAUDE.md).** Those describe v1 as *built for Oak Creek*, which is still accurate. User confirmed 2026-04-15.
...
3. **What it is / what it isn't** (new, short) — sets expectations:
   ...
   - Currently hardcoded to one location (Oak Creek, WI) — see "Adapting to your location" below
...
7. **Adapting to your location (v0.1 — manual)** (new) — walkthrough covering:
   ...
   - **Step 4: Update the hardcoded display strings** in three client files:
     - [client/components/TopBar.tsx:43](../../../client/components/TopBar.tsx#L43) — "OAK CREEK 53154 · KMKE LINK"
