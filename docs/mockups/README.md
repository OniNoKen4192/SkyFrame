...
The mockups use static sample data (the "currently 62°F" and the 12-hour forecast values are hard-coded placeholders that approximate real NWS responses for {CITY, STATE}). The real implementation fetches this data from NOAA/NWS and drops it into the same DOM structure.
